import { evaluateAllRobots, evaluateRobotTelemetry, invalidateRobotPredictionCache, } from "./predictionEngine.js";
/**
 ...
 */
export async function getPredictionByRobotId(robotId) {
    return evaluateRobotTelemetry(robotId);
}
/**
 * Retrieves the 24-hour What-If trajectory for a specific robot.
 */
export async function getWhatIfByRobotId(robotId) {
...
export { evaluateAllRobots, evaluateRobotTelemetry, invalidateRobotPredictionCache, };
