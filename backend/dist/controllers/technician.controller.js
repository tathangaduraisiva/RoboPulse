import { assignRobotToTechnician, createTechnician, deleteTechnician, getAllTechnicians, getTechnicianById, getTechnicianAssignments, removeRobotAssignment, updateTechnician, } from "../services/technician.service.js";
export async function getTechnicians(_req, res) {
    try {
...
export async function createTechnicianHandler(req, res) {
    try {
...
export async function updateTechnicianHandler(req, res) {
    try {
        const id = typeof req.params.id === 'string' ? req.params.id : '';
...
export async function deleteTechnicianHandler(req, res) {
    try {
        const id = typeof req.params.id === 'string' ? req.params.id : '';
...
export async function assignTechnicianRobot(req, res) {
    try {
        const id = typeof req.params.id === 'string' ? req.params.id : '';
...
export async function removeTechnicianRobot(req, res) {
    try {
        const id = typeof req.params.id === 'string' ? req.params.id : '';
        const robotId = typeof req.params.robotId === 'string' ? req.params.robotId : '';
...
export async function getTechnicianAssignmentsHandler(req, res) {
    try {
        const id = typeof req.params.id === 'string' ? req.params.id : '';
