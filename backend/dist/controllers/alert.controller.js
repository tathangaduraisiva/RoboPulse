import { getAllAlerts, acknowledgeAlert, resolveAlert, createAlertRecord, getAlertById as fetchAlertById, updateAlertStatus, } from "../services/alert.service.js";
...
export async function patchResolveAlert(req, res) {
    try {
        const { id } = req.params;
