...
export async function getPredictionForRobot(req: Request, res: Response): Promise<void> {
    try {
...
export async function getWhatIfForRobot(req: Request, res: Response): Promise<void> {
    try {
        const robotId = String(req.params.robotId);
